    ...
    <nav class="d-flex flex-column flex-shrink-0 p-3" id="sidebar">
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <?php
          ...
          ?>
        <li>
          <a href="recomendations.php" class="nav-link active text-light botoesSidebar">
      ...
      <div id="lista">
        ...
        <div id="livrosContainer">
          <?php
              ...
              $sql = "SELECT favoritos FROM usuarios WHERE nome_usuario = 'admin';";
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="https://mollymoreadsandwrites.files.wordpress.com/2015/05/img_8609.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://mollymoreadsandwrites.files.wordpress.com/2015/05/img_8613.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://live.staticflickr.com/5321/10143534955_d89d9b823d_b.jpg" alt="Third slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://cdn.geekwire.com/wp-content/uploads/2015/11/Screen-Shot-2015-11-02-at-3.50.50-PM.png" alt="Fourth slide">
            </div>
