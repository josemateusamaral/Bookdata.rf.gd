...
<body onload="base_configuracao_inicial();configuracao_inicial()">
    ...
    <main>
      ...
      <img src="https://assets-global.website-files.com/5d3e265ac89f6a3e64292efc/6195387416b9eeec95b565fd_Ellipsis-2.6s-194px.gif" alt="loading animation" id="loading">
      <div id="lista"></div>
    </main>
